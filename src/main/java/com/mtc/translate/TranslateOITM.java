...
public class TranslateOITM {
    ...
    public TranslateOITM(){
        ...
        //translateMap.put("种蛋-畸形蛋","big mai");
        //translateMap.put("种蛋-破蛋","big mai");
        //translateMap.put("鸡苗-毛蛋","big mai");
        //translateMap.put("公鸡前期料","big mai");
        //translateMap.put("父母代母鸡苗","big mai");
        //translateMap.put("肉鸡停药期料","big mai");
        //translateMap.put("种鸡育雏料2","big mai");
        //translateMap.put("种鸡产蛋停药期料","big mai");
        //translateMap.put("种鸡产蛋料1","big mai");
        //translateMap.put("种鸡产蛋料2","big mai");
        //translateMap.put("公鸡中期料","big mai");
        //translateMap.put("种公鸡料","big mai");
        //translateMap.put("种公鸡停药期料","big mai");
        //translateMap.put("可销售废料","big mai");
        //translateMap.put("肉鸡后期料","big mai");
        //translateMap.put("种鸡育成料","big mai");
        //translateMap.put("父母代种母鸡","big mai");
        //translateMap.put("自产种蛋","big mai");
        //translateMap.put("外购商品代鸡苗","big mai");
        //translateMap.put("^毛鸡","big mai");
        //translateMap.put("种鸡产前料","big mai");
        //translateMap.put("自产商品代鸡苗","big mai");
        //translateMap.put("劳保用品","big mai");
        //translateMap.put("实验用品","big mai");
        //translateMap.put("化学用品","big mai");
        //translateMap.put("父母代种公鸡","big mai");
        //translateMap.put("父母代公鸡苗","big mai");
        //translateMap.put("种鸡育雏料1","big mai");
        //translateMap.put("鸡维生素","big mai");
        //translateMap.put("外购种蛋","big mai");
        //translateMap.put("鸡苗-损失","big mai");
        //translateMap.put("淘汰雏","big mai");
        //translateMap.put("种蛋-小蛋","big mai");
        //translateMap.put("种蛋-双黄蛋","big mai");
        //translateMap.put("种蛋-损失","big mai");
        //translateMap.put("种鸡-公鸡-死鸡","big mai");
        //translateMap.put("种鸡-公鸡-淘鸡","big mai");
        //translateMap.put("种鸡-公鸡-鉴别错误鸡","big mai");
        //translateMap.put("种鸡-母鸡-死鸡","big mai");
        //translateMap.put("种鸡-母鸡-淘鸡","big mai");
        //translateMap.put("种鸡-母鸡-鉴别错误鸡","big mai");
        //translateMap.put("肉鸡中期料","big mai");
        //translateMap.put("鸡苗-无精蛋","big mai");
        //translateMap.put("肉鸡育雏料","big mai");
        //translateMap.put("外购毛鸡","big mai");
        //translateMap.put("垫料","big mai");
        //translateMap.put("可销售废料","big mai");
